...
class UsersController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            // 'image' => 'required|image|mimes:jpeg,png,jpg,gif,svg|max:2048', // Or 'required|string' if not a file
            'status' => 'required|string', // adjust allowed values as needed
            // 'cin' => 'required|string|max:20', // National ID, if applicable
            'formation_id' => 'required|uuid|exists:formations,id', // Assumes foreign key to formations table
            'account_state' => 'required|integer|in:0,1', // Assumes foreign key to formations table
