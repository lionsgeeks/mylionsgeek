...
Route::middleware(['auth', 'verified', 'role:student'])->group(function () {
    ...
    Route::post('/student/exercises/submissions/{id}/request-review', [ExerciseSubmissionController::class, 'requestReview'])->name('student.exercises.submissions.request-review');
});
