...
Route::middleware(['auth', 'verified', 'role:student'])->group(function () {
    ...
    Route::put('/projects/{studentProject}', [StudentProjectController::class, 'update'])->name('projects.update');
    Route::delete('/projects/{studentProject}', [StudentProjectController::class, 'destroy'])->name('projects.destroy');
});
