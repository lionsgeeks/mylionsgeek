...
Route::middleware(['auth', 'verified', 'role:student'])->group(function () {
    ...
    Route::get('/students/projects', [StudentProjectController::class, 'index'])->name('projects.index');
...
Route::middleware(['auth', 'verified'])->group(function () {
    Route::get('/students/project/{studentProject}', [StudentProjectController::class, 'show'])->name('projects.show');
});
