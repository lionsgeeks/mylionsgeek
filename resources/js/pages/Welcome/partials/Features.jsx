                ...
                <div className="mx-auto w-full px-4 md:max-w-7xl">
                    <div className="text-center space-y-4 mb-16">
                        <div className="inline-flex items-center gap-2 rounded-full border border-neutral-200 dark:border-neutral-800 px-4 py-1.5 text-xs font-medium text-neutral-600 dark:text-neutral-400">
                            <Zap className="w-3 h-3 text-alpha" />
                            Powerful Features
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {features.map((feature, idx) => (
                            <div key={idx} className="group p-6 bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 hover:border-alpha dark:hover:border-alpha transition-all hover:shadow-xl hover:scale-105">
                                <div className="w-12 h-12 rounded-xl bg-alpha/10 flex items-center justify-center mb-4 group-hover:bg-alpha transition-colors">
                                    <feature.icon color={'#000'} className="w-6 h-6 text-amber-600 dark:text-alpha transition-colors" />
                                </div>
