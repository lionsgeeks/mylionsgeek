                        ...
                        <div className="mb-6 rounded-xl border border-alpha/10 bg-white p-5 dark:bg-dark">
                            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                                ...
                                <div className="flex items-center gap-3">
                                    <button
                                        onClick={copyGamePin}
                                        className="inline-flex items-center gap-1 rounded-md bg-alpha px-3 py-2 text-xs font-semibold text-dark hover:bg-alpha/90"
                                    >
                                        <Share2 size={12} />
                                        <span>Copy PIN</span>
                                    </button>
                            ...
                            {liveData.participants && liveData.participants.length > 0 ? (
                                <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                                    {liveData.participants.map((p) => (
                                        ...
                                        >
                                            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-alpha font-bold text-dark">
