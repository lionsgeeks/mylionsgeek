                            ...
                            <table className="min-w-full divide-y divide-sidebar-border/70">
                                <thead className="bg-secondary/50">
                                    <tr>
                                        ...
                                        <th className="px-4 py-3 text-left text-sm font-medium">Equipments</th>
                                ...
                                <tbody className="divide-y divide-sidebar-border/70">
                                    {reservations.map((r) => (
                                        <tr key={r.id} className="hover:bg-accent/30">
                                            ...
                                            <td className="px-4 py-3 text-sm">{(r.type || r.place_type)?.replace('_',' ') ?? '—'}</td>
                                            <td className="px-4 py-3 text-sm"><StatusBadge yes={!!r.approved} trueText="Approved" falseText="Pending" /></td>
                                            <td className="px-4 py-3 text-sm">{r.team_name ? `${r.team_name}${r.team_members ? ` — ${r.team_members}` : ''}` : '—'}</td>
                                            <td className="px-4 py-3 text-sm">{r.equipments ?? '—'}</td>
