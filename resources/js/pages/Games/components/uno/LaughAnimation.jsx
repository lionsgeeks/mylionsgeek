    ...
    return (
        <div className="pointer-events-none fixed inset-0 z-50 flex items-center justify-center">
            <div className="relative">
                ...
                <div
                    className="absolute -top-4 -left-4 text-4xl sm:text-6xl md:text-7xl"
                    style={{
                ...
                <div
                    className="absolute -top-4 -right-4 text-4xl sm:text-6xl md:text-7xl"
                    style={{
                ...
                <div
                    className="absolute top-4 -left-8 text-3xl sm:text-5xl md:text-6xl"
                    style={{
                ...
                <div
                    className="absolute top-4 -right-8 text-3xl sm:text-5xl md:text-6xl"
                    style={{
