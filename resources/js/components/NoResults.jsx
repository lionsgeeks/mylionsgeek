    ...
    return (
        <div className="flex flex-col items-center justify-center px-4 py-16">
            <div className="relative mb-6">
                ...
                <div className="absolute -top-2 -right-2 flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-blue-600">
                        ...
                        <button
                            ...
                            className={`rounded-lg px-6 py-3 font-medium transition-all duration-200 ${
                                action.variant === 'primary'
                                    ? 'transform bg-gradient-to-r from-blue-600 to-blue-700 text-white shadow-lg hover:scale-105 hover:from-blue-700 hover:to-blue-800 hover:shadow-xl'
