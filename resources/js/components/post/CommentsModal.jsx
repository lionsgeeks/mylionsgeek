    ...
    return (
        <>
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                ...
                {/* Modal container */}
                <div className="relative mx-auto flex max-h-[88vh] w-full max-w-md flex-col overflow-hidden rounded-3xl border border-alpha/30 bg-white shadow-2xl transition-all duration-300 animate-in fade-in slide-in-from-bottom-4 dark:border-alpha/20 dark:bg-[#1b1d20]">
                    {/* Close Button */}
                    <button
                        onClick={onClose}
                        aria-label="Close comments"
                        className="absolute top-4 right-4 z-10 rounded-full p-1 text-2xl font-black text-alpha opacity-80 transition hover:opacity-100 focus:ring-2 focus:ring-alpha/50 focus:outline-none"
                    >
                        ×
                    </button>

                    {/* Header */}
                    <div className="border-b border-alpha/30 bg-gradient-to-r from-alpha/10 to-alpha/20 px-6 pt-6 pb-3 dark:border-alpha/30">
                        <h2 className="text-lg font-bold tracking-wide text-alpha uppercase sm:text-base">Comments</h2>
                    </div>

                    {/* Comments list */}
                    <div className="scrollbar-thin scrollbar-thumb-alpha/30 dark:scrollbar-thumb-alpha/20 scrollbar-track-transparent flex-1 space-y-4 overflow-y-auto px-5 py-4 pr-2">
                        {loading ? (
                            ...
                            comments.map((c) => (
                                <div
                                    key={c.id}
                                    className="group flex gap-3 rounded-2xl border border-alpha/20 bg-neutral-50 px-4 py-2 animate-in fade-in slide-in-from-left-2 dark:bg-dark"
                                >
                                    ...
                                    <div className="w-[70%] flex-1 px-3 py-2.5 shadow-sm transition duration-200 hover:shadow-md">
                                        <div className="mb-1 flex justify-between">
                                            <div className="flex flex-col pb-2">
                                                <Link
                                                    href={takeToUserProfile(c)}
                                                    className="truncate text-sm font-bold text-white dark:text-yellow-300"
                                                >
                                                    {c.user_name || 'User'}
                                                </Link>
                    ...
                    <form
                        ...
                        className="flex items-end gap-3 border-t border-alpha/20 bg-neutral-100/60 px-5 py-4 dark:bg-[#1b1d20]"
                    >
                        <Avatar
                            className="h-11 w-11 flex-shrink-0"
                            ...
                            <div className="flex items-end gap-2">
                                <div className="flex-1">
                                    <input
                                        ...
                                        disabled={submitting}
                                        maxLength={2000}
                                        className="w-full rounded-lg border border-alpha/40 bg-white px-4 py-2.5 text-sm text-neutral-800 placeholder-gray-400 shadow-sm transition focus:border-alpha/40 focus:ring-2 focus:ring-alpha focus:outline-0 dark:bg-dark dark:text-neutral-100 dark:placeholder-gray-500"
                                    />
                                </div>
