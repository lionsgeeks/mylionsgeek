    ...
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-2xl bg-light text-dark dark:bg-dark dark:text-light border border-alpha/20 max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Fill the form below to create a new model with badges.
          </DialogDescription>
        </DialogHeader>
        ...
        <form className="space-y-4 mt-4" onSubmit={handleSubmit}>
          ...
          <div>
              ...
              {badge1Preview ? (
                <div className="relative inline-block">
                  <img
                    src={badge1Preview}
                    alt="Badge 1 preview"
                    className="h-32 w-32 object-cover rounded-lg border-2 border-yellow-200 dark:border-yellow-600/30"
                  />
                  <button
                    type="button"
                ...
                <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-yellow-200 dark:border-yellow-600/30 rounded-lg cursor-pointer hover:bg-yellow-50 dark:hover:bg-yellow-900/20 transition-colors">
                  <div className="flex flex-col items-center justify-center pt-5 pb-6">
                    <ImageIcon className="w-8 h-8 mb-2 text-yellow-600 dark:text-yellow-400" />
            ...
            {errors.badge1 && <p className="text-red-600 text-sm mt-1">{errors.badge1}</p>}
          </div>
          ...
          <div>
            ...
            {errors.badge2 && <p className="text-red-600 text-sm mt-1">{errors.badge2}</p>}
          </div>
          ...
          <div>
            ...
            {errors.badge3 && <p className="text-red-600 text-sm mt-1">{errors.badge3}</p>}
          </div>
