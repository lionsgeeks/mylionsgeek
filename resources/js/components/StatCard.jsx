...
export default function StatCard({ title, number, icon: Icon, isSmallNumber = false }) {
    return (
        ...
        >
            ...
            <div className="relative z-10 flex items-center justify-between">
                <div>
                    <div className={`${isSmallNumber ? "text-2xl" : "text-5xl"} font-black text-yellow-600 dark:text-yellow-400 mb-2`}>
                        {number}
                    </div>
